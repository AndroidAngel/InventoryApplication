...
public class DetailsActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        decreaseQuantity = findViewById(R.id.minus_btn);
        increaseQuantity = findViewById(R.id.plus_btn);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (currentItemId == 0) {
            ...
            MenuItem deleteAllMenuItem = menu.findItem(R.id.action_delete_all);
